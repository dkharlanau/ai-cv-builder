...
Audience: People implementing a public professional-profile publishing pipeline. Useful action: Build and inspect the synthetic example HTML, JSON and JSON-LD.

## Sources and publication

- Canonical publication: https://dkharlanau.github.io/ai-cv-builder/
- Profile source: `docs/ai/site-profile.json`; public location: `ai/site-profile.json` under the canonical site base.
- Authoritative site source: `site, templates, examples`.
- Published directory: `dist`.
- Build evidence: `scripts/build-site.mjs; .github/workflows/pages.yml`.
...
Compare a hand-maintained CV page with one-source publishing using the existing synthetic fixture; preserve its noindex and example.com identity.
